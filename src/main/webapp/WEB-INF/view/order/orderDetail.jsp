    ...
    <div class="row justify-content-md-center text-xl-center">
        <div class="col-8 border border-success">
            <table class="table">
                ...
                <c:forEach var="o" items="${getOrderDetail}">
                    <tr>
                        <td>${o.orders.id}</td>
                        <td>${o.productName}</td>
                        <td style="width: 15%;"><img class="img-thumbnail" src="${pageContext.request.contextPath}/resources/img/product/${o.image}.jpg">  </td>
                        <td>${o.quantity}</td>
                        <td>$ ${o.unitPrice}</td>
                    </tr>
                </c:forEach>
