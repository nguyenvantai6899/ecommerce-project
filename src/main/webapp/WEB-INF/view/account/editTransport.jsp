...
<div class="container my-4 text-center">
    <div class="row">
        <div class="col-2 border" style="height: 393px  ">
            <div class="my-5">Account & Security</div>
            <div class="my-3"><a href="#">Account</a></div>
            <div class="my-3"><a href="dAddress">Delivery address</a></div>
        </div>
        <div class="col-10 border border-primary">
            <form action="addDAddress" method="get">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit transport</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="row modal-body">
                    <div class="col-md-1">
                        <label class="form-label">Id</label>
                        <input type="text" name="id" value="${transport.id}" readonly class="form-control">
                    </div>
                    <div class="col-md-7">
                        <label class="form-label">Name</label>
                        <input type="text" name="name" value="${transport.name}" class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Tel</label>
                        <input type="text" name="tel"   value="${transport.tel}" class="form-control">
                    </div>
                    <div class="col-12">
                        <label class="form-label">Address</label>
                        <input type="text" name="address" value="${transport.address}" class="form-control" placeholder="">
                    </div>
                </div>
